...
describe("SignIn component snapshot", () => {
  ...
  // console.log("link a is ",linkArr[0].textContent)
  // console.log("link a is ",linkArr[1].textContent)
  // console.log("link a is ",linkArr[2].textContent)
    act(() => {
    ...
    act(() => {
      ...
      linkArr[2].dispatchEvent(new MouseEvent('click', { bubbles: true }));
