...
describe("categories reducer actions", () => {
  ...
  it("adding item to cart reducer", () => {
    const action = {
      ...
      payload: [{ id: 2, name: "item2", quantity: 3,price: 1000 },
                { id: 3, name: "item3", quantity: 1,price: 1000 }]
...
describe("ActionCreators Testing", () => {
  ...
  it("delete cart item",async ()=>{
    const item=4;
    const getState=()=>{
      return {cart:{rows:[{ id: 1, name: "item1", quantity: 2 },{ id: 2, name: "item2", quantity: 1 },{ id: 4, name: "item4", quantity: 5 }]}};
    };
    const expectedAction=[{
      type : 'CART_DELETE_ITEM',
      payload : [{id: 1, name: "item1", quantity: 2},{ id: 2, name: 'item2', quantity: 1 }]
    }];
    const localStorageMock = {
    getItem: jest.fn(),
    setItem: jest.fn(),
  ...
  it("changing cart item quantity", async () => {
    ...
    const expectedAction = [{
      type: 'CART_CHANGE_QUANTITY',
      payload: [{ id: 1, name: "item1", quantity: 2 }, { id: 2, name: "item2", quantity: 10 }]
    }];
